...
<tr>
<td>
<p>데이터 모델 섹션에 대한 캔버스 보기는 기존 테이블 보기와 함께 캔버스 레이아웃에서 데이터 모델 및 해당 링크의 시각화를 활성화하여 경험을 향상시킵니다. </p>
<p>캔버스 보기가 있는 데이터 모델은 현재 사용자를 선택하는 베타로 사용할 수 있습니다.</p>
...
<thead>
<tr>
<th><strong>제품 지식에 대한 AI 지원</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
...
<thead>
<tr>
<th><strong>프로필 저장 활동</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
<td>
<p> 이제 Federated Audience Composition에서 프로필 보강 사용 사례를 지원하므로, 고객은 외부 데이터 웨어하우스의 데이터를 사용하여 기존 Experience Platform 프로필을 개선할 수 있습니다.
</p>
<p>자세한 내용은 <a href="../compositions/activities/save-profiles.md">자세한 설명서</a>를 참조하세요.</p>
</br>
</td>
</tr>
</tbody>
...
* **큰 대상 내보내기**
  ...
  이제 Federated Audience Composition에서 파일 크기가 1GB보다 큰 큰 대상자의 내보내기를 지원합니다.
...
* **Amazon Redshift 보안 연결**
  ...
  이 새로운 릴리스에서는 Federated Audience Composition이 Amazon Redshift 데이터베이스에 대한 보안 비공개 링크 연결을 지원합니다. [자세히 알아보기](../connections/federated-db.md#amazon-redshift)

* **Google 큰 쿼리**

  이 새로운 릴리스에서는 Federated Audience Composition이 Google Big Query 데이터베이스에 대한 보안 VPN 연결을 지원합니다. [자세히 알아보기](../connections/federated-db.md#google-big-query)
...
* **B2B CDP 고객 지원**
  ...
  페더레이션된 대상자 컴포지션은 이제 기업 간(B2B) 고객 데이터 플랫폼(CDP) 고객을 대상으로 사람 대상자 사용 사례를 제공합니다.
...
>[!AVAILABILITY]
>
>이전에는 조직 집합에만 사용할 수 있었던(LA) Adobe Experience Platform 페더레이션된 대상자 컴포지션을 이제 모든 사용자가 사용할 수 있습니다(GA). 이 기능은 귀하가 제공하는 서비스를 기반으로 활성화되며, 관련 권한이 있는 경우에만 볼 수 있습니다. [자세히 알아보기](access-prerequisites.md)
>
...
[이 페이지](get-started.md)와 [자주 묻는 질문](faq.md)에서 페더레이션된 대상자 컴포지션에 대해 자세히 알아보십시오.

[이 페이지](access-prerequisites.md)에서 페더레이션된 대상자 컴포지션에 액세스하기 위한 사전 요구 사항 및 현재 가드레일에 대한 자세한 내용을 알아보십시오.
