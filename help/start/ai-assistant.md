...
1. 상단 표시줄에 있는 아이콘을 선택하여 AI 어시스턴트에 액세스합니다.

   AI 어시스턴트는 화면의 오른쪽 섹션에 표시됩니다. ![자세히 살펴보기 이미지 대체 텍스트](assets/do-not-localize/Smock_FullScreen_18_N.svg "펼치기")를 선택하여 AI 어시스턴트 창을 펼칠 수 있습니다.
