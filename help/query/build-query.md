...
1. 다음에서 **속성** 필드에서 조건을 만드는 데 활용할 데이터베이스에서 속성을 선택합니다. 속성 목록에는 연결된 테이블의 속성을 포함하여 데이터베이스의 모든 속성이 포함됩니다.
   ...
   >[!NOTE]
   >
   >다음 **표현식 편집** 단추를 사용하면 웹 표현식 편집기를 활용하여 데이터베이스 및 도우미 함수의 필드를 사용하여 표현식을 수동으로 정의할 수 있습니다. [표현식 편집 방법 알아보기](expression-editor.md)
...
1. 다음에서 **값** 필드에서 예상 값을 정의합니다. 웹 표현식 편집기를 활용하여 데이터베이스 및 도우미 함수의 필드를 사용하여 표현식을 수동으로 정의할 수도 있습니다. 이렇게 하려면 **표현식 편집** 단추를 클릭합니다. [표현식 편집 방법 알아보기](expression-editor.md)
...
* **필터 선택 또는 저장**: 캔버스에서 사용할 기존의 사전 정의된 필터를 선택하거나 나중에 다시 사용할 수 있도록 쿼리를 사전 정의된 필터로 저장합니다. <!--[Learn how to work with predefined filters](../get-started/predefined-filters.md)-->
