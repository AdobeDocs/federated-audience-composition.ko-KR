...
>title="규칙 속성"
>abstract="캔버스에 쿼리를 작성한 후에는 오른쪽에 있는 **[!UICONTROL 규칙 속성]** 창을 사용하여 확인할 수 있습니다.<br/>이 창에서는 결과 데이터를 표시하고, 쿼리의 SQL 코드 버전을 검색하고, 타겟팅된 레코드 수를 확인할 수 있습니다.<br/> **[!UICONTROL 필터 선택 또는 저장]** 버튼을 사용하여 쿼리를 미리 정의된 필터로 저장하거나 캔버스 콘텐츠를 기존 필터로 바꿀 수 있습니다."
