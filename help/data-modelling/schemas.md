...
>title="스키마 설명"
>abstract="스키마 설명에는 열, 유형 및 레이블이 나열됩니다. 스키마에 대한 조정 키를 확인할 수도 있습니다. 스키마 정의를 업데이트하려면 연필 아이콘을 선택합니다."
...
![테이블 선택 팝오버가 표시됩니다.](assets/schemas/select-table.png){zoomable="yes"}
