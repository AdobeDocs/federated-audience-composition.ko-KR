...
컴포지션을 시작하려면 **[!UICONTROL 시작]** 화면의 오른쪽 상단에 있는 단추입니다. 컴포지션이 실행 중일 때 캔버스의 각 활동은 컴포지션의 끝에 도달할 때까지 순차적 순서로 실행됩니다.
...
컴포지션 로그 및 작업 모니터링은 컴포지션을 분석하고 제대로 실행되고 있는지 확인하는 중요한 단계입니다. 다음에서 액세스할 수 있습니다. **[!UICONTROL 로그]** 작업 도구 모음 및 각 활동의 속성 창에서 사용할 수 있는 단추입니다.

![](assets/logs-button.png)

다음 **[!UICONTROL 구성 로그 및 작업]** 화면은 모든 사용자 작업을 기록하고 오류가 발생한 작성 실행 기록을 제공합니다.
...
* 다음 **[!UICONTROL 작업]** 탭에서는 활동의 실행 시퀀싱에 대해 자세히 설명합니다. 각 작업의 끝에 있는 버튼을 사용하면 활동을 통해 전달된 이벤트 변수를 나열할 수 있습니다.
* 다음 **[!UICONTROL 변수]** 탭에는 컴포지션에 전달된 모든 변수가 나열됩니다. 작성 캔버스에서 로그 및 작업에 액세스할 때만 사용할 수 있습니다. 이제 활동의 속성 창에서 로그에 액세스할 때 사용할 수 있습니다.  <!-- à confirmer-->
...
* **시작**: 컴포지션 실행을 시작하고 다음 작업을 수행합니다. **진행 중** 상태. 작성이 시작되고 초기 활동이 활성화됩니다.

* **[!UICONTROL 다시 시작]**: 일시 중지된 컴포지션 실행을 다시 시작합니다. 컴포지션은 다음 작업을 수행합니다. **진행 중** 상태.

* **[!UICONTROL 일시 중지]** 컴포지션의 실행, 그런 다음 **일시 중지됨** 상태. 다시 시작될 때까지 새 활동이 활성화되지 않지만 진행 중인 작업은 중단되지 않습니다.

* **[!UICONTROL 중지]** 실행 중인 컴포지션. 그런 다음 해당 컴포지션을 **완료됨** 상태. 진행 중인 작업은 가능한 경우 중단됩니다. 중지된 동일한 위치에서 컴포지션을 다시 시작할 수 없습니다.

* **다시 시작**: 컴포지션을 중지한 후 다시 시작합니다. 대부분의 경우 중지하려면 특정 시간이 소요되므로 이 작업을 빠르게 다시 시작할 수 있습니다. **시작** 단추는 중지가 유효한 경우에만 사용할 수 있습니다.
