...
- **Adobe Journey Optimizer 대상 여정 읽기에서 Federated Audience Composition 대상으로 다중 엔터티 타깃팅**
...
- **Snowflake에 대해 암호화되지 않은 키 지원**

  이제 키 쌍 인증을 사용하여 Snowflake 데이터 웨어하우스에 연결할 때 암호화되지 않은 키를 사용할 수 있습니다.

  Snowflake에서 암호화되지 않은 키를 사용하는 방법에 대한 자세한 내용은 [연결 개요](/help/connections/home.md)를 참조하십시오.
