---
title: Federated Audience Composition 릴리스 노트(2025)
description: 2025년 Federated Audience Composition에 대한 릴리스 노트.
...
* **프로필 보강 사용 사례의 증분 업데이트**
  ...
  프로필 저장 활동 사용에 대한 자세한 내용은 활동 안내서 [&#128279;](/help/compositions/activities.md#save-profiles)의 프로필 저장 섹션에서 확인할 수 있습니다.
...
<p>자세한 내용은 <a href="../data-modelling/models.md">세부 설명서</a>를 참조하십시오.</p>
</br>
</td>
</tr>
</tbody>
...
* **Amazon Redshift 보안 연결**
  ...
  이 새로운 릴리스에서는 Federated Audience Composition이 Amazon Redshift 데이터베이스에 대한 보안 PrivateLink 연결을 지원합니다. [자세히 알아보기](../connections/home.md#amazon-redshift)
